  ...
  return (
    <main className="min-h-screen flex flex-col bg-white">
      ...
      <div className="container mx-auto px-4 md:px-8 pt-64 pb-16">
        ...
        {/* MVAI 프로세스 영역 */}
        <AnimatedSection delay={1300} className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <AnimatedSection delay={1500} className="bg-gray-50 p-6 rounded-md shadow-sm border border-gray-100 h-full">
            ...
            <AnimatedSection delay={1700} className="bg-gray-50 p-6 rounded-md shadow-sm border border-gray-100 h-full">
              <div className="flex items-start mb-4">
            ...
            {/* 3단계: Post-Production */}
            <AnimatedSection delay={1900} className="bg-gray-50 p-6 rounded-md shadow-sm border border-gray-100 h-full">
              <div className="flex items-start mb-4">
