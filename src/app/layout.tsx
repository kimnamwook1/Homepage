...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://www.thejpc.kr/images/thejpc-og-image.png", // 절대 URL 사용
        width: 1200,
        height: 630,
        alt: "TheJPC",
      },
  ...
  twitter: {
    ...
    title: "TheJPC",
    description: "We create opportunity.",
    images: ["https://www.thejpc.kr/images/thejpc-og-image.png"], // 트위터용 이미지도 동일하게 설정
  },
};
  ...
  return (
    <html lang="en" className="light">
      <head>
        ...
        <meta property="og:image" content="https://www.thejpc.kr/images/thejpc-og-image.png" />
        ...
        <meta name="twitter:image" content="https://www.thejpc.kr/images/thejpc-og-image.png" />
      </head>
